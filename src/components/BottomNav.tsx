import { Home, TrendingUp, Copy, Bot, MoreHorizontal, Shield, LogOut, CreditCard, BarChart, Zap, Send, BookOpen, GraduationCap, Crown, Info, HelpCircle, ChevronRight, Smartphone } from "lucide-react";
            ...
            <div className="space-y-1 pb-4">
              ...
              <Collapsible open={supportOpen} onOpenChange={setSupportOpen}>
                ...
                <CollapsibleContent className="space-y-1 pl-1">
                  ...
                  <MenuButton icon={Smartphone} label="Install App" onClick={() => navigateTo("/install")} />
